                ...
                >
                    ...
                    >
                         <div className="space-y-2 md:space-y-1">
                            <h2 className="text-foreground text-3xl md:text-[40px] font-semibold leading-tight md:leading-[53px] font-funnel">
                                {title}
                            </h2>
                        </div>

                        <p className="text-muted-foreground text-sm md:text-[15px] leading-6 font-funnel">
                            {description}
                        </p>
                    </motion.div>
                    ...
                    >
                        ...
                        {/* Main Mockup Card */}
                        <motion.div
                            className="relative w-full h-[405px] md:h-[637px] bg-card/50 rounded-[32px] backdrop-blur-[15px] backdrop-brightness-[100%] border z-10 overflow-hidden"
                            initial={{ y: reverseLayout ? 0 : 0 }}
                            whileInView={{ y: reverseLayout ? 20 : 30 }}
