                        ...
                        <div className="mx-auto max-w-7xl px-6">
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    ...
                                    <h1 className="mt-8 max-w-4xl mx-auto text-balance text-6xl md:text-7xl lg:mt-16 xl:text-[5.25rem] whitespace-pre-line">
                                        Migrate Smarter{'\n'}Build Faster
                                    </h1>
...
function LogoCloud() {
    const modelProviders = [
        {
            name: "OpenAI",
            logo_url: "https://img.logo.dev/openai.com?token=pk_J5OZ7CacQmekbGRbXKo2Lw"
        },
        {
            name: "Claude",
            logo_url: "https://img.logo.dev/claude.ai?token=pk_J5OZ7CacQmekbGRbXKo2Lw"
        },
        {
            name: "Mistral AI",
            logo_url: "https://img.logo.dev/mistral.ai?token=pk_J5OZ7CacQmekbGRbXKo2Lw"
        },
        {
            name: "Grok",
            logo_url: "https://img.logo.dev/grok.com?token=pk_J5OZ7CacQmekbGRbXKo2Lw"
        }
    ]
    ...
    return (
        <section className="py-16 bg-background">
            <div className="max-w-5xl m-auto px-6">
                <h2 className="text-lg text-center text-foreground font-medium">Works with your favourite model providers</h2>
                <div className="mx-auto mt-20 flex max-w-4xl flex-wrap items-center justify-center gap-x-12 gap-y-8 sm:gap-x-16 sm:gap-y-12">
                    {modelProviders.map((provider, index) => (
                        <img 
                            key={index}
                            className="h-8 w-fit dark:invert opacity-60 hover:opacity-100 transition-opacity" 
